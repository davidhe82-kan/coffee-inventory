...
import { X, Coffee, AlertCircle, CheckCircle } from 'lucide-react'
...
export function QuickAddModal({ isOpen, onClose, onSuccess }: QuickAddModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      <div className="absolute inset-0 bg-coffee-950/50 backdrop-blur-sm" onClick={onClose} />
      <div className="relative w-full max-w-lg bg-cream-50 rounded-t-2xl sm:rounded-2xl shadow-xl animate-slide-up max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-4 border-b border-coffee-200">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-coffee-800">快捷添加咖啡豆</h3>
          </div>
          <button onClick={onClose} className="p-2 rounded-full hover:bg-coffee-100 transition-colors">
...
价格：xx元"
        ...
        <div className="flex gap-3 p-4 border-t border-coffee-200">

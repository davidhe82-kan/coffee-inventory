...
export function AddEspressoPage() {
    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-10 bg-cream-100/95 backdrop-blur-sm border-b border-coffee-300/60 shadow-[0_2px_8px_rgba(62,39,35,0.05)] px-5 py-4">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-coffee-900">添加意式记录</h1>
      ...
      <main className="max-w-2xl mx-auto px-5 py-6 space-y-6">
        ...
        <div className="flex gap-3">
          <Button variant="ghost" onClick={() => navigate('/espresso')} className="flex-1 border border-coffee-300">
            取消
          </Button>

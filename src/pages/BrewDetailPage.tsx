    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/brew" className="text-coffee-500 hover:text-coffee-700">
            返回列表
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen pb-20">
      <header className="sticky top-0 z-10 bg-cream-100/95 backdrop-blur-sm border-b border-coffee-200 px-5 py-4">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <Link to="/brew" className="flex items-center gap-2 text-coffee-700 hover:text-coffee-900">
            <ArrowLeft className="w-5 h-5" />
            <span className="text-sm font-medium">返回</span>
          </Link>
          <div className="flex items-center gap-2">
            <Link to={`/brew/${record.id}/edit`}>
      ...
      <main className="max-w-2xl mx-auto px-5 py-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-cream-50 rounded-lg p-4">
              <div className="flex items-center gap-2 text-coffee-500 mb-1">
                ...
                <span className="text-xs">豆量</span>
              </div>
            ...
            <div className="bg-cream-50 rounded-lg p-4">
              ...
              <p className="text-xl font-semibold text-coffee-900">{record.waterTemp}<span className="text-sm font-normal text-coffee-500"> °C</span></p>
            </div>
            ...
            {record.dripper && (
              <div className="bg-cream-50 rounded-lg p-4">
                <div className="flex items-center gap-2 text-coffee-500 mb-1">
                  <Filter className="w-4 h-4" />
                  <span className="text-xs">滤杯</span>
                </div>
                <p className="text-base font-medium text-coffee-900">{record.dripper}</p>
              </div>
            )}
        ...
        {record.technique && (
          <div className="bg-white rounded-xl border border-coffee-100 p-6">
            <h2 className="text-lg font-semibold text-coffee-800 mb-3">手法描述</h2>
            <p className="text-coffee-600 leading-relaxed whitespace-pre-line">{record.technique}</p>
          </div>
        )}
